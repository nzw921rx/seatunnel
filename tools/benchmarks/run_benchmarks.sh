...
if [[ -z "${benchmark_pr_number}" ]]; then
    run_benchmark baseline result "${benchmark_ref}"
    ...
    run_benchmark baseline baseline-1 "${benchmark_ref}"
    run_benchmark candidate candidate-1 "PR #${benchmark_pr_number}"
    run_benchmark candidate candidate-2 "PR #${benchmark_pr_number}"
    run_benchmark baseline baseline-2 "${benchmark_ref}"
    python3 baseline/tools/benchmarks/regression_report.py \
